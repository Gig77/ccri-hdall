p <- read.delim("~/hdall/results/filtered-variants.cosmic.tsv")
x <- read.delim("~/p2ry8-crlf2/results/filtered-variants.xenografts.tsv")
...
write.table(m, file="~/hdall/results/check-xeno-af.tsv", quote=F, sep="\t", row.names=F)
