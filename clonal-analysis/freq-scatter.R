...
#patients <- c("399", "314")
t <- read.csv("/mnt/projects/hdall/results/filtered-variants.cosmic.normaf.tsv", sep="\t", stringsAsFactors=F)
t <- t[t$status != "REJECT",]

pdf("/mnt/projects/hdall/results/clonal-analysis/freq-scatter.pdf", width=12, paper='A4r')
...
pdf("/mnt/projects/hdall/results/clonal-analysis/freq-scatter.normaf.pdf", width=12, paper='A4r')
