s <- read.delim("/mnt/projects/hdall/results/exomeCopy/allpatients.compiled-segments.exomeCopy.tsv")
sf <- s
...
write.table(sf, "/mnt/projects/hdall/results/exomeCopy/allpatients.filtered-segments.exomeCopy.tsv.part", row.names=F, col.names=T, sep="\t", quote=F)