...
pdf("~/kamilla/results/current/kernel-densities.allpatients.dia.pdf", height=12, paper='A4')
...
pdf("~/kamilla/results/current/kernel-densities.allpatients.rel.pdf", height=12, paper='A4')
par(mfrow = c(6, 4), mar=c(2,0.5,2,0.5))
for(p in patients)
{
...
pdf("~/kamilla/results/current/patient715-kernel-density.pdf", width=12, paper='A4r')
par(mfrow = c(1, 2))
...
pdf("~/kamilla/results/current/patient545-kernel-density.pdf", width=12, paper='A4r')
par(mfrow = c(1, 2))
