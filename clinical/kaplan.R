...
plot(fit, col=c("red", "blue"), lty=c(1, 5), xlab="months", ylab="pOS", conf.int=F, xlim=c(0,125), yaxt='n', cex.axis=1.3, cex.lab=1.5)
...
lines(fit.overall, col="black", lty=2, conf.int=F)
...
legend("bottomright", c(sprintf("MRD SR (%d/%d)", sum(fit[2]$n.event), fit[2]$n), sprintf("overall (%d/%d)", sum(fit.overall$n.event), fit.overall$n), sprintf("MRD HR (%d/%d)", sum(fit[1]$n.event), fit[1]$n)), lwd=c(1,1), col=c("blue", "black", "red"), lty=c(5, 2, 1))
text(1, 0, substitute(italic(P) == p, list(p=sprintf("%.2g", 1 - pchisq(survdiff(form, data=c)$chisq, length(survdiff(form, data=c)$n) - 1)))), adj=0, cex=1.3)

rm(form); form <- Surv(time=second_rem_months, had_second_event_after_first)~mrd_risk_rel
rm(fit); fit <- survfit(form, data=c) 
plot(fit, col=c("red", "blue"), lty=c(1, 5), xlab="months", ylab="pEFS", conf.int=F, xlim=c(0,125), yaxt='n', cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="red", adj=0, cex=1.3)
text(60, fit[2]$surv[max(which(fit[2]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[2]$surv[max(which(fit[2]$time<=60))], fit[2]$std.err[max(which(fit[2]$time<=60))]), col="blue", adj=0, cex=1.3)
...
#rm(fit); fit <- survfit(form, data=c) 
#plot(fit, col=c("red", "blue"), lty=c(1, 5), xlab="months", ylab="pRFS after 1st relapse", conf.int=F, xlim=c(0,125), yaxt='n', cex.axis=1.3, cex.lab=1.5)
#axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
#text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="red", adj=0, cex=1.3)
#text(60, fit[2]$surv[max(which(fit[2]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[2]$surv[max(which(fit[2]$time<=60))], fit[2]$std.err[max(which(fit[2]$time<=60))]), col="blue", adj=0, cex=1.3)
...
plot(fit[1:2], xlab="months", ylab="CIR", curvlab=c("MRD HR", "MRD SR"), col=c("red", "blue"), wh=c(-100,-100), yaxt='n', lty=c(1, 5), xlim=c(0,125), cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
...
tp <- tp[order(tp)]
lines(tp, timepoints(fit.overall, tp)$est[1,], col="black", lty=2, type="s")
...
legend("topright", c(sprintf("MRD HR (%d/%d)", sum(complete.cases(c[c$mrd_risk_rel=="HR" & c$second_event_after_first_relapse=="2nd rel", "second_rem_months"])),  sum(complete.cases(c[c$mrd_risk_rel=="HR",c("second_rem_months", "second_event_after_first_relapse")]))),
			...
			lwd=c(1,1), col=c("red", "black", "blue"), lty=c(1, 2, 5))
text(1, 1, substitute(italic(P) == p, list(p=sprintf("%.2g", fit$Tests["2nd rel", "pv"]))), adj=0, cex=1.3)

# --- RAS PW ---

rm(form); form <- Surv(time=second_rem_months, dead)~ras.relapsing.rel
rm(fit); fit <- survfit(form, data=c) 
plot(fit, col=c("blue", "red"), lty=c(5, 1), xlab="months", ylab="pOS", conf.int=F, xlim=c(0,125), yaxt='n', cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
...
rm(fit); fit <- survfit(form, data=c) 
plot(fit, col=c("blue", "red"), lty=c(5, 1), xlab="months", ylab="pEFS", conf.int=F, xlim=c(0,125), yaxt='n', cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="blue", adj=0, cex=1.3)
text(60, fit[2]$surv[max(which(fit[2]$time<=60))]-0.05, sprintf("%.2f, SE=%.2f", fit[2]$surv[max(which(fit[2]$time<=60))], fit[2]$std.err[max(which(fit[2]$time<=60))]), col="red", adj=0, cex=1.3)
legend("bottomright", c(sprintf("mRAS (%d/%d)", sum(fit[2]$n.event), fit[2]$n), sprintf("wtRAS (%d/%d)", sum(fit[1]$n.event), fit[1]$n)), lwd=c(1,1), col=c("red", "blue"), lty=c(1, 5))
...
#rm(fit); fit <- survfit(form, data=c) 
#plot(fit, col=c("blue", "red"), lty=c(5, 1), xlab="months", ylab="pRFS after 1st relapse", conf.int=F, xlim=c(0,125), yaxt='n', cex.axis=1.3, cex.lab=1.5)
#axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
#text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="blue", adj=0, cex=1.3)
#text(60, fit[2]$surv[max(which(fit[2]$time<=60))]-0.05, sprintf("%.2f, SE=%.2f", fit[2]$surv[max(which(fit[2]$time<=60))], fit[2]$std.err[max(which(fit[2]$time<=60))]), col="red", adj=0, cex=1.3)
#legend("bottomright", c(sprintf("mRAS (%d/%d)", sum(fit[2]$n.event), fit[2]$n), sprintf("wtRAS (%d/%d)", sum(fit[1]$n.event), fit[1]$n)), lwd=c(1,1), col=c("red", "blue"), lty=c(1, 5))
...
plot(fit[1:2], xlab="months", ylab="CIR", curvlab=c("wtRAS", "mRAS"), col=c("blue", "red"), wh=c(-100,-100), yaxt='n', lty=c(5, 1), xlim=c(0,125), cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
...
legend("topright", c(sprintf("mRAS (%d/%d)", sum(complete.cases(c[c$ras.relapsing.rel & c$second_event_after_first_relapse=="2nd rel", "second_rem_months"])),  sum(complete.cases(c[c$ras.relapsing.rel, c("second_rem_months", "second_event_after_first_relapse")]))), 
		...
		lwd=c(1,1), col=c("red", "blue"), lty=c(1, 5))
text(1, 1, substitute(italic(P) == p, list(p=sprintf("%.2g", fit$Tests["2nd rel", "pv"]))), adj=0, cex=1.3)
...
#text(1, 0, substitute(italic(P) == p, list(p=sprintf("%.2g", 1 - pchisq(survdiff(form, data=c)$chisq, length(survdiff(form, data=c)$n) - 1)))), adj=0)
...
plot(fit, col=c("red", "blue", "#882255", "black"), lty=c(1, 3, 4, 2), xlab="months", ylab="pOS", conf.int=F, yaxt='n', cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="red", adj=0, cex=1.3)
text(60, fit[2]$surv[max(which(fit[2]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[2]$surv[max(which(fit[2]$time<=60))], fit[2]$std.err[max(which(fit[2]$time<=60))]), col="blue", adj=0, cex=1.3)
text(60, fit[3]$surv[max(which(fit[3]$time<=60))]-0.05, sprintf("%.2f, SE=%.2f", fit[3]$surv[max(which(fit[3]$time<=60))], fit[3]$std.err[max(which(fit[3]$time<=60))]), col="#882255", adj=0, cex=1.3)
...
legend("bottomright", c(sprintf("mPTPN11 (%d/%d)", sum(fit[3]$n.event), fit[3]$n), sprintf("mNRAS (%d/%d)", sum(fit[2]$n.event), fit[2]$n), sprintf("wtRAS (%d/%d)", sum(fit[4]$n.event), fit[4]$n), sprintf("mKRAS (%d/%d)", sum(fit[1]$n.event), fit[1]$n)), lty=c(4, 3, 2, 1), col=c("#882255", "blue", "black", "red"))
text(1, 0, substitute(italic(P) == p, list(p=sprintf("%.2g", 1 - pchisq(survdiff(form, data=c[c$ras.pw.gene.rel!="FLT3",])$chisq, length(survdiff(form, data=c[c$ras.pw.gene.rel!="FLT3",])$n) - 1)))), adj=0, cex=1.3)

rm(form); form <- Surv(time=second_rem_months, had_second_event_after_first)~ras.pw.gene.rel
rm(fit); fit <- survfit(form, data=c[c$ras.pw.gene.rel!="FLT3",]) 
plot(fit, col=c("red", "blue", "#882255", "black"), lty=c(1, 3, 4, 2), xlab="months", ylab="pEFS", conf.int=F, yaxt='n', cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="red", adj=0, cex=1.3)
text(60, fit[2]$surv[max(which(fit[2]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[2]$surv[max(which(fit[2]$time<=60))], fit[2]$std.err[max(which(fit[2]$time<=60))]), col="blue", adj=0, cex=1.3)
text(60, fit[3]$surv[max(which(fit[3]$time<=60))]-0.05, sprintf("%.2f, SE=%.2f", fit[3]$surv[max(which(fit[3]$time<=60))], fit[3]$std.err[max(which(fit[3]$time<=60))]), col="#882255", adj=0, cex=1.3)
...
#rm(fit); fit <- survfit(form, data=c[c$ras.pw.gene.rel!="FLT3",]) 
#plot(fit, col=c("red", "blue", "#882255", "black"), lty=c(1, 3, 4, 2), xlab="months", ylab="pRFS after 1st relapse", conf.int=F, yaxt='n', cex.axis=1.3, cex.lab=1.5)
#axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
#text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="red", adj=0, cex=1.3)
#text(60, fit[2]$surv[max(which(fit[2]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[2]$surv[max(which(fit[2]$time<=60))], fit[2]$std.err[max(which(fit[2]$time<=60))]), col="blue", adj=0, cex=1.3)
#text(60, fit[3]$surv[max(which(fit[3]$time<=60))]-0.05, sprintf("%.2f, SE=%.2f", fit[3]$surv[max(which(fit[3]$time<=60))], fit[3]$std.err[max(which(fit[3]$time<=60))]), col="#882255", adj=0, cex=1.3)
...
plot(fit[1:4], xlab="months", ylab="CIR", curvlab=c("mKRAS", "mNRAS", "mPTPN11", "wtRAS"), col=c("red", "blue", "#882255", "black"), wh=c(-100,-100), yaxt='n', lty=c(1, 3, 4, 2), xlim=c(0,125), cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
...
text(60, timepoints(fit, 60)$est["PTPN11 2nd rel",]+0.03, sprintf("%.2f, SE=%.2f", timepoints(fit, 60)$est["PTPN11 2nd rel",], timepoints(fit, 60)$var["PTPN11 2nd rel",]), col="#882255", adj=0, cex=1.3)
...
legend("topright", c(sprintf("mKRAS (%d/%d)", sum(complete.cases(c[c$ras.pw.gene.rel=="KRAS" & c$second_event_after_first_relapse=="2nd rel", "second_rem_months"])),  sum(complete.cases(c[c$ras.pw.gene.rel=="KRAS", c("second_rem_months", "second_event_after_first_relapse")]))),
					...
					lwd=c(1,1), col=c("red", "black", "blue", "#882255"), lty=c(1, 2, 3, 4))
text(1, 1, substitute(italic(P) == p, list(p=sprintf("%.2g", fit$Tests["2nd rel", "pv"]))), adj=0, cex=1.3)
...
rm(fit); fit <- survfit(form, data=c) 
plot(fit, col=c("red", "black", "blue"), lty=c(1, 5, 4), xlab="months", ylab="pOS", conf.int=F, yaxt='n', cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="red", adj=0, cex=1.3)
...
legend("right", c(sprintf("mCREBBP (%d/%d)", sum(fit[1]$n.event), fit[1]$n),
				  ...
				  sprintf("wtCREBBP+mKRAS (%d/%d)", sum(fit[2]$n.event), fit[2]$n)), lty=c(1, 4, 5), col=c("red", "blue", "black"))
text(1, 0, substitute(italic(P) == p, list(p=sprintf("%.2g", 1 - pchisq(survdiff(form, data=c)$chisq, length(survdiff(form, data=c)$n) - 1)))), adj=0, cex=1.3)

rm(form); form <- Surv(time=second_rem_months, had_second_event_after_first)~kras.crebbp.rel
rm(fit); fit <- survfit(form, data=c) 
plot(fit, col=c("red", "black", "blue"), lty=c(1, 5, 4), xlab="months", ylab="pEFS", conf.int=F, yaxt='n', cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
text(60, fit[1]$surv[max(which(fit[1]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[1]$surv[max(which(fit[1]$time<=60))], fit[1]$std.err[max(which(fit[1]$time<=60))]), col="red", adj=0, cex=1.3)
text(60, fit[2]$surv[max(which(fit[2]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[2]$surv[max(which(fit[2]$time<=60))], fit[2]$std.err[max(which(fit[2]$time<=60))]), col="black", adj=0, cex=1.3)
text(60, fit[3]$surv[max(which(fit[3]$time<=60))]+0.04, sprintf("%.2f, SE=%.2f", fit[3]$surv[max(which(fit[3]$time<=60))], fit[3]$std.err[max(which(fit[3]$time<=60))]), col="blue", adj=0, cex=1.3)
...
#rm(fit); fit <- survfit(form, data=c) 
#plot(fit, col=c("black", "red", "blue"), lty=c(3, 1, 4), xlab="months", ylab="pRFS after 1st relapse", conf.int=F, yaxt='n', cex.axis=1.3, cex.lab=1.5)
#axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
...
plot(fit[1:3], xlab="months", ylab="CIR", curvlab=c("mCREBBP", "wtCREBBP+mKRAS", "wtCREBBP+wtKRAS"), col=c("red", "black", "blue"), wh=c(-100,-100), yaxt='n', lty=c(1, 5, 4), xlim=c(0,125), cex.axis=1.3, cex.lab=1.5)
axis(side=2, at=seq(0, 1, by=0.1), cex.axis=1.3)
...
legend("topright", c(sprintf("mCREBBP (%d/%d)", sum(complete.cases(c[c$kras.crebbp.rel=="mCREBBP" & c$second_event_after_first_relapse=="2nd rel", "second_rem_months"])),  sum(complete.cases(c[c$kras.crebbp.rel=="mCREBBP", c("second_rem_months", "second_event_after_first_relapse")]))), 
		...
		lwd=c(1,1), col=c("red", "blue", "black"), lty=c(1, 4, 5))
text(1, 1, substitute(italic(P) == p, list(p=sprintf("%.2g", fit$Tests["2nd rel", "pv"]))), adj=0, cex=1.3)
